...
## :medal_sports:<span style="color:#29c4f6"> PURPOSE

<i>"Welcome to the Boat Lifestyle Website Landing Page repository! This README file provides an overview of the project, including its purpose, features, and setup instructions.

The Boat Lifestyle Website Landing Page is a simple and visually appealing website designed to showcase the beauty and freedom of the boat lifestyle. The website aims to entice users to explore more about the boat lifestyle and its benefits.

Let's embark on this journey to recreate the Cartier website together, learning and growing as web developers along the way! 😊😊"</i>
...
<ul>Applied for styling and layout with different CSS properties </ul>
 ...
 #### <span style="color:#ef00ff">3. FONT AWESOME 
...
#### <span style="color:#ef00ff">4. GOOGLE FONTS AND ICONS
...
## :hourglass_flowing_sand:<span style="color:#29c4f6">CONTACT
